                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse justify-content-end align-center " id="navi">
                            <ul className="navbar-nav mb-2 ps-1" id="nave">
                                <li className="nav-item"><a href="#" className="nav-link active text-info"
                                ...
                                <li className="nav-item"><a href="#pricing" className="nav-link text-light">Pricing</a></li>
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-light ps-3">
                                        <li><a href="#" className="dropdown-item"></a>Front-end Development</li>
                                        <li><a href="#" className="dropdown-item"></a>Back-end Development</li>
                                        <li><a href="#" className="dropdown-item"></a>Product Design</li>
                                        <li><a href="#" className="dropdown-item"></a>UI/UX Design</li>
                                        <li><a href="#" className="dropdown-item"></a>Digital Marketing</li>
                                    </ul>
                                </li>
                                <li className="nav-item"><a href="#contact" className="nav-link text-light">Contacts</a></li>
